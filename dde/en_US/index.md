...
- If there are several accounts set in the computer, click on ![changeusers](icon/changeusers_icon.svg) in the lower right corner of login interface to switch user account. Specific operations refer to  [Switch User](#Switch User).

- If you want to shut down, restart or suspend, please click on ![shutdown](icon/shutdown_icon.svg) to enter shutdown interface, specific operations refer to [Enter Shutdown Interface](#Enter Shutdown Interface).
