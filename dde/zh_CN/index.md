...
深度操作系统 15 是武汉深之度科技有限公司于2015年12月发布的 Linux 的桌面操作系统。在深度操作系统中，已经预装了 WPS Office、搜狗输入法、有道词典以及深度系列的特色软件。它既能让您体验到丰富多彩的娱乐生活，也可以满足您的日常工作需要。相信随着功能的不断升级和完善，深度操作系统将会被越来越多的用户所喜爱和使用。

## 使用入门|common/icon_guide.svg|

### 打开启动器和控制中心

桌面的四个顶角已经默认设置了热区，通过热区您可以快速打开启动器和控制中心：

* 将鼠标指针置于桌面左上角便可以打开启动器，在启动器的任意位置点击一下鼠标便可以从启动器界面返回到桌面。

* 将鼠标指针置于桌面右下角便可以打开控制中心，在控制中心面板以外的区域点击一下鼠标便可以退出控制中心。
...
3. 如果要退出关机界面，请按下键盘上的 ![Esc](icon/Esc.svg) 键或在关机界面的空白处点击一下鼠标。
...
当电脑接通电源后，按下主机上的电源按钮，电脑开机。

#### 关机

1. 在控制中心，点击底部的 ![power](icon/power_icon.png)。
2. 点击 **关机** 或按下键盘上的 ![Enter](icon/Enter.svg) 键。

### 登录

电脑开机后，在您正式执行各项操作之前，您需要先使用一个账户来登录电脑。
...
> ![notes](icon/notes.svg)：电脑默认的登录账户是您在安装系统时所设置的用户名和密码。登录电脑后，您可以创建新的账户，具体操作请参阅 [创建新账户](dman:///deepin-controlcenter#创建新账户)。

您还可以进行如下操作：

-  如果这台电脑已经设置了多个用户账户，在登录界面的右下角将会显示 ![changeusers](icon/changeusers_icon.png)。点击它您可以选择其他的用户账户来登录，具体操作请参阅 [切换用户](#切换用户)。
...
注销是清除当前登录用户的信息。当执行注销操作之后，电脑会重新进入登录界面，此时您可以使用任何一个用户账户来登录电脑。
...
如果您的电脑已经设置了多个用户账户，当注销或锁定电脑后，您可以使用其他的用户账户来登录电脑。

1. 在控制中心，点击底部的 ![power](icon/power_icon.png)。
2. 点击 **切换用户**，此时您可以看到当前电脑上的所有用户账户。
3. 选择一个用户账户。
4. 输入用户账户对应的密码。
...
> ![notes](icon/notes.svg)：电脑进入待机模式的时间，您可以根据自己的需要来设置，具体操作请参阅 [电源节能操作](dman:///deepin-controlcenter#电源节能操作)。
...
任务栏帮助您固定常用的应用程序，它通常显示在桌面底部，您可以使用鼠标从电脑的任何地方找到它。
...
控制中心允许您查看和进行基本的系统设置，包括更改用户账户，设置屏幕显示等，具体操作请参阅 *控制中心* 帮助手册。
...
*  如果您切换到经典模式或高效模式，回收站将在桌面环境中显示。
*  如果您切换到时尚模式，回收站将在任务栏中显示。

![1|trash](png/trash.png)
...
> ![notes](icon/notes.svg)：关于个性化的设置，具体操作请参阅 [个性化设置](dman:///deepin-controlcenter#个性化设置)。
...
> ![notes](icon/notes.svg)：关于显示的设置，具体操作请参阅 [单屏设置](dman:///deepin-controlcenter#单屏设置)。
...
有些图标例如网络、声音默认在通知区域中显示，您可以执行以下操作来隐藏或显示这些图标：

1. 在桌面，将鼠标指针置于任务栏上。
2. 点击鼠标右键，选择 **通知区域设置**。
3. 向左或向右滑动按钮来开启或关闭网络、声音的图标显示。
...
1. 在桌面，点击鼠标右键。
2. 点击 **热区设置**，此时整个屏幕会变暗并且在屏幕的四个顶角处将显示对应的热区功能。
3. 如果要退出热区设置，请在桌面的空白处点击一下鼠标。

#### 修改热区

您可以对桌面四个顶角的热区功能重新进行设置。

1. 在桌面，点击鼠标右键。
2. 点击 **热区设置**。
3. 将鼠标指针置于桌面的某个顶角处，在选项中重新选择一项。
...
当然，如果您已经知道了应用程序的名称，通过直接输入关键字的方式可以更加快速的搜索到需要的应用程序！
...
2. 右键单击应用程序图标，您可以：
   ...
   * 点击 **发送到桌面**，在桌面创建快捷方式。
   * 点击 **添加到任务栏**，将应用程序固定到任务栏。
   * 点击 **添加至开机启动项**，将应用程序添加到开机启动项，在电脑开机时自动运行该应用程序。

![0|sendto](png/sendto.png)

>![notes](icon/notes.svg)：您可以通过鼠标将应用程序的图标从启动器或桌面拖拽到任务栏上放置。但是当应用程序处于运行状态时您将无法拖拽固定，此时您可以右键单击任务栏上的应用程序图标，选择 **驻留** 将应用程序固定到任务栏，以便在下次使用时能够从任务栏上快速打开。
...
2. 右键单击应用程序图标，您可以：
   ...
   * 点击 **从桌面上移除**，删除桌面快捷方式。
   * 点击 **从开机启动项移除**，从开机启动项中移除该应用程序。

> ![notes](icon/notes.svg)：按住鼠标左键不放，将应用程序图标拖拽到任务栏以外的区域，也可以将固定到任务栏上的应用程序移除。但是当应用程序处于运行状态时您将无法拖拽移除，此时您可以右键单击任务栏上的应用程序图标，选择 **移除驻留** 将应用程序从任务栏上移除。
...
2. 直接点击应用程序图标或右键单击应用程序图标，选择 **打开**。

对于已经创建了桌面快捷方式或已经固定到任务栏上的应用程序，您还可以通过以下途径来打开应用程序：

* 双击桌面图标或右键单击桌面图标，选择 **打开** 。
* 直接点击任务栏上的应用程序图标或右键单击任务栏上的应用程序图标，选择 **运行** 。
...
> ![tips](icon/tips.svg)：在 **时尚模式** 下，您还可以在启动器界面，按住鼠标左键不放，将应用程序图标拖拽到 ![trash](icon/trash_icon.png) 中卸载应用程序。
...
1. 在桌面，将鼠标指针置于程序组上。
2. 右键单击程序组，选择 **打开** 或直接点击程序组，此时程序组中的所有应用程序将全部展开显示。
3. 点击要运行的应用程序。
...
如果您确定不再需要以程序组的方式来管理应用程序，您可以将程序组解散。
...
存放在桌面上的文件您可以按一定的规则来排列，让电脑桌面看起来更整洁。
...
![1|compressfile](png/compressfile.png)
...
* 在桌面上，按下键盘上的 ![Ctrl](icon/Ctrl.svg) + ![Alt](icon/Alt.svg) + ![Left](icon/Left.svg) / ![Right](icon/Right.svg) 组合键，可以切换到上一个/下一个工作区。
* 在桌面上，按下键盘上的 ![Ctrl](icon/Ctrl.svg) + ![Alt](icon/Alt.svg) + **数字键**，可以切换到指定的工作区。
* 在工作区的管理界面，通过上下滚动鼠标滚轮或按下键盘上的 ![Alt](icon/Alt.svg) + ![Left](icon/Left.svg) / ![Right](icon/Right.svg) 组合或键来切换到上一个/下一个工作区。
...
> ![attention](icon/attention.svg)：当您执行删除工作区操作后，该工作区中的所有窗口将自动转移到相邻的工作区中显示，当桌面环境中只存在一个工作区时，将不能执行删除工作区的操作。
...
- 按下键盘上的 ![Shift](icon/Shift.svg) + ![Tab](icon/Tab.svg) 键，将切换到当前窗口的上一个窗口。
...
* 在桌面上，按住键盘上的 ![Alt](icon/Alt.svg) 键不放，连续按下键盘上的 ![Tab](icon/Tab.svg) 键，窗口依次向右切换显示；连续按下键盘上的  ![Shift](icon/Shift.svg) + ![Tab](icon/Tab.svg)键，窗口依次向左切换显示。
* 在桌面上，按住键盘上的 ![Alt](icon/Alt.svg) 键不放，连续按下键盘上的 ![~](icon/~.svg) 键，当前同类型窗口依次向右切换显示；连续按下键盘上的  ![Shift](icon/Shift.svg) +  ![~](icon/~.svg) 键，当前同类型的窗口依次向左切换显示。

![1|allwindow](png/allwindow.png)

### 在桌面移动窗口

* 在桌面上，按下键盘上的 ![Super](icon/Super.svg) + ![Shift](icon/Shift.svg) + ![Left](icon/Left.svg) / ![Right](icon/Right.svg) 键，将当前窗口移动到上一个/下一个工作区；按下键盘上的  ![Super](icon/Super.svg)+ ![Shift](icon/Shift.svg) + **数字键**，可以将当前窗口移动到指定的工作区。
* 在桌面上，按下键盘上的 ![Ctrl](icon/Ctrl.svg) + ![Alt](icon/Alt.svg) + ![Shift](icon/Shift.svg) + ![Left](icon/Left.svg) / ![Right](icon/Right.svg) 键，将当前窗口移动到上一个/下一个工作区；按下键盘上的 ![Ctrl](icon/Ctrl.svg) + ![Alt](icon/Alt.svg) + ![Shift](icon/Shift.svg) + **数字键**，可以将当前窗口移动到指定的工作区。
